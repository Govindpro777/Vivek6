...
const steps = [
  ...
  },
  {
    ...
    description: "You'll need some SOL in your wallet to swap for $GALLOP. Get it from a centralized exchange or a friend who owes you one.",
  },
  {
    icon: ArrowRightLeft,
    title: "3. SWAP FOR $GALLOP",
    description: "Go to PancakeSwap, paste the $GALLOP contract address, and swap your SOL. Welcome to the mainframe.",
  },
];
  ...
  return (
    <section id="how-to-buy" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          Get started with $GALLOP in three simple steps
        </motion.p>
